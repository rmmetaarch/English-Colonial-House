...
const englishColonialHouse = new Entity('englishColonialHouse')
engine.addEntity(englishColonialHouse)
englishColonialHouse.setParent(_scene)
const transform5 = new Transform({
  position: new Vector3(16, 0, 16),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
englishColonialHouse.addComponentOrReplace(transform5)
const gltfShape3 = new GLTFShape("f7d3c672-5962-4b0b-98ae-d37256e7d1d4/English Colonial House.glb")
gltfShape3.withCollisions = true
gltfShape3.isPointerBlocker = true
gltfShape3.visible = true
englishColonialHouse.addComponentOrReplace(gltfShape3)
